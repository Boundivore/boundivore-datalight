...
public class ConfigLogicJmxYaml extends AbstractConfigLogic {
    ...
    public static final String JMX_CONFIG_FILE_SparkHistoryServer = "jmx_config_SparkHistoryServer.yaml";

    public static final String SERVICE_NAME = "SPARK";
    ...
    public String config(File file, String replacedTemplated) {
        ...
        switch (file.getName()) {
            // SparkHistoryServer
            case JMX_CONFIG_FILE_SparkHistoryServer:
