 ...
 * Version: V1.0
 */
public class ConfigLogicHdfsSiteXml extends AbstractConfigLogic {


    public ConfigLogicHdfsSiteXml(PluginConfig pluginConfig) {
        super(pluginConfig);
    }
    ...
    private String nn1Hostname() {
        Map<String, PluginConfig.MetaComponent> hdfsMetaComponentMap = super.pluginConfig
                .getMetaServiceMap()
                .get("HDFS")
                .getMetaComponentMap();
    ...
    private String nn2Hostname() {
        ...
        String nameNode2AndNodeId = hdfsMetaComponentMap.keySet()
                .stream()
