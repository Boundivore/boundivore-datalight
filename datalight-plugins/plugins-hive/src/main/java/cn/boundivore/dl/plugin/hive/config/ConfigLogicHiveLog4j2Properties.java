...
/**
 * Description: 配置 hive-log4j2.properties 文件
 ...
 * Version: V1.0
 */
public class ConfigLogicHiveLog4j2Properties extends AbstractConfigLogic {


    public ConfigLogicHiveLog4j2Properties(PluginConfig pluginConfig) {
        super(pluginConfig);
    }
