...
public class ConfigLogicJmxYaml extends AbstractConfigLogic {
    ...
    public static final String JMX_CONFIG_FILE_SolrServer = "jmx_config_SolrServer.yaml";

    public static final String SERVICE_NAME = "SOLR";
    ...
    public String config(File file, String replacedTemplated) {
        ...
        switch (file.getName()) {
            // SolrServer
            case JMX_CONFIG_FILE_SolrServer:
