 ...
 */
package cn.boundivore.dl.plugin.solr.config.event;
...
/**
 * Description: SOLR 关联的服务发生变动时，检查是否需要联动修改自身的配置文件
...
public class ConfigEventHandler extends AbstractConfigEventHandler {
    ...
    private static final String INSTALL_PROPERTIES_PATH = "SOLR/ranger-solr-plugin/install.properties";
