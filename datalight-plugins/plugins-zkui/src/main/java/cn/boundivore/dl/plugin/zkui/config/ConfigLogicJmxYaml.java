...
public class ConfigLogicJmxYaml extends AbstractConfigLogic {
    ...
    public static final String JMX_CONFIG_FILE_ZKUIServer = "jmx_config_ZKUIServer.yaml";

    public static final String SERVICE_NAME = "ZKUI";
    ...
    public String config(File file, String replacedTemplated) {
        ...
        switch (file.getName()) {
            // SparkHistoryServer
            case JMX_CONFIG_FILE_ZKUIServer:
