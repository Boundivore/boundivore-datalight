...
/**
 * Description: 配置  ranger-usersync-services.sh 文件
 ...
 * Version: V1.0
 */
public class ConfigLogicRangerUserSyncServicesSh extends AbstractConfigLogic {

    public ConfigLogicRangerUserSyncServicesSh(PluginConfig pluginConfig) {
        super(pluginConfig);
    }
    ...
    public String config(File file, String replacedTemplated) {
        ...
        return replacedTemplated
                ...
                .replace(
                        "{{jmxExporterPort_RangerUserSync}}",
