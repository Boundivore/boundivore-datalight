...
| SPARK  | 3.2.4  | 2023-09-14 |
| HBASE  | 2.5.5  | 2023-09-14 |
...
| 7    | guava、tez       | [llap-tez](.\src-HIVE-3.1.3)             | org.apache.hadoop.hive.llap.tezplugins.LlapTaskSchedulerService |
...
| 30   | tez              | [llap-tez](.\src-HIVE-3.1.3)             | org.apache.hadoop.hive.llap.tezplugins.LlapTaskCommunicator  |
| 31   | tez              | [ql](.\src-HIVE-3.1.3)                   | org.apache.hadoop.hive.ql.exec.tez.TezTask                   |
...
# 配置 Tez 依赖
cd /data/install/HIVE
mkdir ./lib-aux
tar -zxf ./HIVE/tez/tez.tar.gz -C ./lib-aux
cd ./lib-aux
rm -f rm -rf LICENSE  LICENSE-BSD-3clause  LICENSE-CDDLv1.0  LICENSE-CDDLv1.1-GPLv2_withCPE  LICENSE-MIT  LICENSE-SIL_OpenFontLicense-v1.1  NOTICE
mv ./lib/* ./

# 拷贝 MySQL 驱动包
cp -a /data/install/mysql-connector-java-5.1.47.jar ./HIVE
