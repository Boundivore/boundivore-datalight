...
主包命名：dlc-tez-0.9.2.tar.gz

~~~shell
find ./ -name "*.tar.gz"

tar -zxf ./tez-dist/target/tez-0.9.2.tar.gz -C /data/install/
tar -zxf ./tez-dist/target/tez-0.9.2-minimal.tar.gz -C /data/install/

cd /data/install
mv apache-hive-3.1.3-bin HIVE/
mv apache-hive-metastore-3.1.3-bin metastore/
mv metastore/ HIVE/
