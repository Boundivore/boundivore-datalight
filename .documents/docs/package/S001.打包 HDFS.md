...
~~~shell
yum -y install git gcc gcc-c++ gcc-header make autoconf automake libtool yasm nasm curl openssl openssl-devel ncurses-devel snappy snappy-devel bzip2 bzip2-devel lzo lzop lzo-devel libXtst zlib zlib-devel gcc-c++ autoconf 
...
# cmake
cd /data/install/compile
wget https://cmake.org/files/v3.20/cmake-3.20.2.tar.gz --no-check-certificate
tar -zxvf cmake-3.20.2.tar.gz -C /data/install/compile
cd cmake-3.20.2/
