...
# 单独编译 tez-ui 前端框架
cd /data/install/tez-src/tez-branch-0.10.2/tez-ui/src/main/webapp
...
cd /data/install/tez-src/tez-branch-0.10.2/tez-ui
...
~~~shell
# 整体编译 tez
cd tez-src/tez-branch-0.10.2/tez-ui
mvn clean package -DskipTests=true
~~~

备注：tez 0.10.2 中官方二进制包已经移除了 tez-ui 包，需自行编译
...
~~~shell
cd /data/install
tar -zxf ./apache-tomcat-9.0.87.tar.gz -C /data/install
...
cp -a /data/install/apache-src/tez-src/tez-branch-0.10.2/tez-ui/target/tez-ui-0.10.2.war /data/install/HIVE/tez/tomcat/webapps/tez-ui/
cd /data/install/tomcat/webapps/tez-ui
jar -xvf tez-ui-0.10.2.war
~~~
...
cp -a ./tez-dist/target/tez-0.10.2.tar.gz -C /data/install/tez
cd /data/install/tez
mv tez-0.10.2.tar.gz tez.tar.gz
mv tez-0.10.2-minimal.tar.gz tez-minimal.tar.gz
