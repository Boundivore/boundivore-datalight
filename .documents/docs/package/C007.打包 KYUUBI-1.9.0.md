...
| 服务   | 版本   | 时间       |
| ------ | ------ | ---------- |
| KYUUBI | 1.9.0  | 2024-08-04 |
| HADOOP | 3.2.4  | 2024-04-29 |
| HIVE   | 3.1.3  | 2023-09-14 |
| SPARK  | 3.1.3  | 2024-04-29 |
...
~~~http
https://dlcdn.apache.org/kyuubi/kyuubi-1.9.0/apache-kyuubi-1.9.0-source.tgz
~~~
...
~~~shell
cd /data/install/apache-src/kyuubi-src/kyuubi-1.9.0

build/dist --tgz --flink-provided --spark-provided --hive-provided -Pspark3.1 -Pflink-1.19
~~~
...
cp -a ./apache-kyuubi-1.9.0-SNAPSHOT-bin.tgz /data/install/

cd /data/install/

tar -zxf ./apache-kyuubi-1.9.0-SNAPSHOT-bin.tgz -C ./

mv apache-kyuubi-1.9.0-SNAPSHOT-bin/ KYUUBI/

tar -zcf dlc-kyuubi-1.9.0.tar.gz KYUUBI/
~~~
