...
-- ----------------------------
-- Table structure for t_dl_alert
-- ----------------------------
DROP TABLE IF EXISTS `t_dl_alert`;
CREATE TABLE `t_dl_alert`
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '告警配置信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '处理告警接口配置信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '处理告警邮箱配置信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '告警与处理告警信息关联表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '进程自动拉起状态表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '集群信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '组件信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '配置信息表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `sha256`      varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件内容摘要 256 位摘要算法，极低碰撞概率，用于比较文件内容是否相同(文件内容，也可考虑+文件绝对路径)',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE KEY `uk_dlcc_cluster_file_sha256` (`cluster_id`, `filename`, `sha256`) COMMENT '集群配置文件内容唯一索引'
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '配置文件内容信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '服务组件预配置信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '初始化步骤缓存信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Job 信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'Job 工作日志信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '登录事件记录表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '日志埋点信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '节点初始化信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Job 节点工作信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'Job 节点工作日志信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Step 节点步骤信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Task 节点任务信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '权限信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '权限角色信息映射表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '角色绑定关系表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '接口资源规则表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '服务信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Stage 信息表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `method`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT NULL COMMENT 'method 名称',
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Step 信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Task 信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用户认证信息表'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '前端状态信息缓存表'
  ROW_FORMAT = DYNAMIC;
