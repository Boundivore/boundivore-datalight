...
SOLR_DATA_HOME="${DATA_DIR}/SOLR"
SOLR_PID_DIR="${PID_DIR}/SOLR"

ZK_HOST={{ZK_HOST}}
SOLR_LOGS_DIR="${LOG_DIR}/SOLR"

export SOLR_SERVER_JMX_OPTS="-Djava.net.preferIPv4Stack=true \
-Dcom.sun.management.jmxremote.authenticate=false \
-Dcom.sun.management.jmxremote.ssl=false \
-Dcom.sun.management.jmxremote.local.only=false \
-Dcom.sun.management.jmxremote.port={{jmxRemotePort_SolrServer}} \
-javaagent:${DATALIGHT_DIR}/exporter/jar/jmx_exporter.jar={{jmxExporterPort_SolrServer}}:${SERVICE_DIR}/SOLR/exporter/conf/jmx_config_SolrServer.yaml"
