...
DEFAULT_ENV_PID_DIR="${PID_DIR}/FLINK"              # Directory to store *.pid files to
...
DEFAULT_HADOOP_CONF_DIR="{{DEFAULT_HADOOP_CONF_DIR}}"                          # Hadoop Configuration Directory, if necessary
DEFAULT_HBASE_CONF_DIR="{{DEFAULT_HBASE_CONF_DIR}}"                           # HBase Configuration Directory, if necessary
