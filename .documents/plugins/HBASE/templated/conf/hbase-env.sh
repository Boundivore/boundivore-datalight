...
export HBASE_HMASTER_JMX_OPTS="-Djava.net.preferIPv4Stack=true \
-Dcom.sun.management.jmxremote.authenticate=false \
-Dcom.sun.management.jmxremote.ssl=false \
-Dcom.sun.management.jmxremote.local.only=false \
-Dcom.sun.management.jmxremote.port={{jmxRemotePort_HMaster}} \
-javaagent:${DATALIGHT_DIR}/exporter/jar/jmx_exporter.jar={{jmxExporterPort_HMaster}}:${SERVICE_DIR}/HBASE/exporter/conf/jmx_config_HMaster.yaml"


export HBASE_HREGIONSERVER_JMX_OPTS="-Djava.net.preferIPv4Stack=true \
-Dcom.sun.management.jmxremote.authenticate=false \
-Dcom.sun.management.jmxremote.ssl=false \
-Dcom.sun.management.jmxremote.local.only=false \
