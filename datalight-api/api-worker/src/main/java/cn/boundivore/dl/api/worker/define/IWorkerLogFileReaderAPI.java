 ...
 * Version: V1.0
 */
@Tag(name = "Worker 接口：读取日志文件相关", description = "IWorkerLogFileReaderAPI")
@FeignClient(
...
public interface IWorkerLogFileReaderAPI {
    ...
    @Operation(summary = "获取日志文件列表", description = "获取日志文件列表")
    ...
    @Operation(summary = "分步加载文件内容", description = "分步加载文件内容")
