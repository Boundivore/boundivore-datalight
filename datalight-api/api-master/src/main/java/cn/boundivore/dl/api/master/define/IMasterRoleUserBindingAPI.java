 ...
 * Version: V1.0
 */
@Tag(name = "Master 接口：角色用户绑定关系相关", description = "IMasterRoleUserBindingAPI")
@FeignClient(
...
public interface IMasterRoleUserBindingAPI {
    ...
    @Operation(summary = "根据角色用户 ID 建立角色用户绑定关系", description = "根据角色用户 ID 建立角色用户绑定关系")
    ...
    @Operation(summary = "根据角色用户 ID 移除角色用户绑定关系", description = "根据角色用户 ID 移除角色用户绑定关系")
    ...
    @Operation(summary = "根据用户 ID 移除角色用户绑定关系", description = "根据用户 ID 移除角色用户绑定关系")
