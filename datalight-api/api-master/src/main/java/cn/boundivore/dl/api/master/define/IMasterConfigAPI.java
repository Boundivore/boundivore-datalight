 ...
 * Version: V1.0
 */
@Tag(name = "Master 接口：配置相关", description = "IMasterConfigAPI")
@FeignClient(
...
public interface IMasterConfigAPI {
    ...
    @Operation(summary = "保存配置项", description = "保存配置项")
    ...
    @Operation(summary = "根据分组保存配置项", description = "根据分组保存配置项")
    ...
    @Operation(summary = "获取当前服务的配置信息概览列表", description = "获取当前服务的配置信息概览列表")
    ...
    @Operation(summary = "获取服务组件的配置", description = "获取服务组件的配置")
    ...
    @Operation(summary = "反向同步配置文件", description = "反向同步配置文件")
