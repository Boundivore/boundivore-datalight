...
public interface Executor {
     ...
     * the process then {@link Executor#execute(CommandLine)}
     * will throw an {@link ExecuteException}
     *
     ...
     *  <li>an empty array for auto-detect of successful exit codes relying on {@link Executor#isFailure(int)}</li>
     *  <li>null to indicate to skip checking of exit codes</li>
     * </ul>
     *
     * If an undefined exit value is returned by the process then
     * {@link Executor#execute(CommandLine)}  will
     * throw an {@link ExecuteException}.
     *
