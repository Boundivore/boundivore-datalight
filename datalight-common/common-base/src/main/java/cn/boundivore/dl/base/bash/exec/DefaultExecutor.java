 ...
 */
package cn.boundivore.dl.base.bash.exec;

import cn.boundivore.dl.base.bash.exec.launcher.CommandLauncher;
import cn.boundivore.dl.base.bash.exec.launcher.CommandLauncherFactory;
...
public class DefaultExecutor implements Executor {
    ...
    /**
     * @see Executor#setWorkingDirectory(File)
     */
    ...
    /**
     * @see Executor#execute(CommandLine)
     */
    ...
    /**
     * @see Executor#execute(CommandLine, Map)
     */
...
//        ExecutorPoolUtil.execute(getExecutorThread());
    ...
    private int executeInternal(final CommandLine command, final Map<String, String> environment,
        ...
        try {
            ...
            try {
                ...
                ThreadUtil.interrupt(executorThread, true);
            }            
