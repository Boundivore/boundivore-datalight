...
public abstract class AbstractNodeInitVo {
    ...
    @ApiModel(
            value = "AbstractNodeInitVo.NodeInitVo",
    ...
    public static class NodeInitVo implements IVo {
        ...
        @ApiModelProperty(name = "NodeInitDetailList", value = "节点初始化信息详情列表", required = true)
    ...
    @Accessors(chain = true)
    @ApiModel(
            value = "AbstractNodeInitVo.NodeInitDetailVo",
    ...
    public static class NodeInitDetailVo implements IVo {
        ...
        @ApiModelProperty(name = "NodeId", value = "节点初始化主键 ID", required = true)
