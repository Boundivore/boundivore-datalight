...
/**
 * Description: IServiceComponentConverter
...
public interface IServiceComponentConverter {
    ...
    AbstractServiceComponentVo.ServiceSummaryVo convert2ServiceSummaryVo(YamlServiceDetail.Service service);

    @Mappings({
            @Mapping(source = "name", target = "componentName"),
            @Mapping(source = "mutexes", target = "mutexesList")
    })
    AbstractServiceComponentVo.ComponentSummaryVo convert2ComponentSummaryVo(YamlServiceDetail.Component component);
