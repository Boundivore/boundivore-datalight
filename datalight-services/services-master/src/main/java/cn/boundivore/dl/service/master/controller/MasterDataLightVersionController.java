...
/**
 * Description: MasterDataLightVersionController
...
public class MasterDataLightVersionController implements IMasterDataLightVersionAPI {

    private final MasterDataLightVersionService masterDataLightVersionService;

    @Override
    public Result<DataLightVersionVo> getDataLightVersion() throws Exception {
        return this.masterDataLightVersionService.getDataLightVersion();
    }
}
