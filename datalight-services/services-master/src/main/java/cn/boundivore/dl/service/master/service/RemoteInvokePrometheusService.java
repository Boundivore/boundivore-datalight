...
public class RemoteInvokePrometheusService {

    private final Feign.Builder feignBuilder;

    /**
     * Description: Feign 远程调用指定节点的 IThirdPrometheusAPI 的接口
     * Created by: Boundivore
     * E-mail: boundivore@foxmail.com
     ...
     * Throws:
     *
     * @param prometheusIp   prometheus IP 地址
