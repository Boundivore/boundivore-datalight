...
public class ClusterMeta {
    ...
    private ClusterTypeEnum currentClusterTypeEnum;

    private Long relativeCusterId;

    private String relativeClusterName;

    private ClusterTypeEnum relativeClusterTypeEnum;
}
