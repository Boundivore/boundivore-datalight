...
@TableName("t_dl_permission_final")
@ApiModel(value = "TDlPermissionFinal对象", description = "权限信息常量表")
public class TDlPermissionFinal extends TBasePo<TDlPermissionFinal> {
