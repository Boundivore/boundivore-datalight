...
@TableName("t_dl_permission_rule_relation")
@ApiModel(value = "TDlPermissionRuleRelation对象", description = "接口权限与规则映射表")
public class TDlPermissionRuleRelation extends TBasePo<TDlPermissionRuleRelation> {
