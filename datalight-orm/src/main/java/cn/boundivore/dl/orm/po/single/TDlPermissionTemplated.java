...
@TableName("t_dl_permission_templated")
@ApiModel(value = "TDlPermissionTemplated对象", description = "权限信息常量模板表")
public class TDlPermissionTemplated extends TBasePo<TDlPermissionTemplated> {
